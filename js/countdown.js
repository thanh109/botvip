/* jCountdown 1.4.3 jQuery Plugin Copyright 2012 Tom Ellis
http://www.webmuse.co.uk | MIT Licensed (license.txt) */
                    ...
                    return this.each(function() {
                        ...
                        if (!n.hasCompleted) {
                            ...
                            if (n.stopwatch && n.direction === "up") {
                                var i = S(t).getTime() - n.pausedAt.getTime(),
                                    s = new Date;
