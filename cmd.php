...
$start_allhost = "all-vip-on";
$stop_allhost  = "all-vip-off";

$check_support = "ken sp";

$check_superadmin  = "check super admin";
$add_superadmin    = "add super admin";
$remove_superadmin = "del super admin";

$check_admin  = "check-adm";
$add_admin    = "add-adm";
$remove_admin = "del-adm";
...
$check_blackList  = "ckbl-vip";
$add_blacklist    = "adbl-vip";
$remove_blacklist = "deblvip";

$check_ip   = "check-ip";
$check_user = "check-u";

$delete_message     = "delm";
$delete_message_all = "clear all-vip";
$delete_user_files  = "clean-file";
...
$start_notify = "noti-vip-on";
$stop_notify  = "noti-vip-off";
